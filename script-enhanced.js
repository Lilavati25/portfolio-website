...
const elementsToAnimate = document.querySelectorAll('.timeline-item, .project-card, .skill-category, .education-card, .stat-item, .award-item, .cert-item');
...
// ===== PARALLAX EFFECT ===== (Disabled to prevent overlap)
// Commented out to fix section overlap issue
// window.addEventListener('scroll', () => {
...
console.log('%cBuilt with ❤️ using HTML, CSS, and JavaScript', 'font-size: 12px; color: #10b981;');
...
document.addEventListener('keydown', (e) => {
    ...
    if (konamiCode.join('').includes(konamiSequence.join(''))) {
        showNotification('🚀 Achievement Unlocked: Code Master! You found the secret!', 'success');
